  ...
  <div class="container py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
      <h3 class="fw-bold text-dark mb-0 d-flex align-items-center gap-2">
        <i class="bi bi-clock-history text-warning"></i> Lịch Sử Đơn Hàng
      </h3>
    ...
    <div v-else-if="orders.length === 0" class="card border-0 shadow-sm rounded-4 p-5 text-center">
      ...
      <p class="text-muted small mb-3">Bạn chưa có đơn hàng nào ở trạng thái này.</p>
      ...
      <div v-for="order in orders" :key="order.id" class="card border-0 shadow-sm rounded-4 p-4">
        ...
        <div class="row g-2 mb-3 bg-light p-3 rounded-3 small">
          ...
          <div class="col-md-4">
            ...
            <strong>Số điện thoại:</strong> {{ order.receiverPhone || 'N/A' }}
          </div>
          <div class="col-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center pt-2">
          <div class="d-flex align-items-center gap-2">
            ...
            <!-- NÚT MUA LẠI (KHI ĐÃ GIAO HOẶC ĐÃ HỦY) -->
            <button 
...
const handleCancelOrder = async (orderId) => {
  ...
  try {
    ...
    notify(err.response?.data?.message || err.response?.data || "Không thể hủy đơn hàng lúc này.", 'danger')
  }
}
