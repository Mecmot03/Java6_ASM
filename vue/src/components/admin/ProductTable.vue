            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <tr v-for="product in products" :key="product.id">
                        ...
                        <td>
                            <span :class="product.quantity > 0 ? 'fw-bold text-dark' : 'badge bg-secondary'">
                                {{ product.quantity }}
                            </span>
                        </td>

                        <td>
                            <span v-if="product.status && product.quantity > 0" class="badge bg-success">
                                Đang bán
                            </span>
                            <span v-else-if="product.status && product.quantity <= 0" class="badge bg-warning text-dark">
                                Hết hàng
                            </span>
